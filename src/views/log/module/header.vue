<template>
  <div class="head-container">
    ...
    <el-date-picker v-model="query.daterange" :picker-options="pickerOptions2" class="filter-item" style="width: 370px;" size="small" type="datetimerange" unlink-panels range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期"/>
