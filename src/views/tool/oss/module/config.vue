<template>
  <el-form ref="form" :model="form" :rules="rules" style="margin-top: 6px;" size="small" label-width="130px">
    <el-form-item label="服务提供商" prop="serviceProvider"><el-select v-model="oss.serviceName" placeholder="请选择" style="width: 200px" @on-change="changeOss">
      <el-option value="LOCAL_OSS">本地服务器</el-option>
      <el-option value="MINIO_OSS">MinIO</el-option>
      <el-option value="QINIU_OSS">七牛云</el-option>
      <el-option value="ALI_OSS">阿里云</el-option>
      <el-option value="TENCENT_OSS">腾讯云</el-option>
    ...
    <div v-if="oss.serviceName !== 'LOCAL_OSS'">
      ...
      <el-form-item v-if="oss.serviceName === 'QINIU_OSS'" label="zone存储区域：" prop="zone">
      ...
      <el-form-item v-if="oss.serviceName=='TENCENT_OSS'" label="所属地域：" prop="bucketRegion">
